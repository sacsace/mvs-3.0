...
const PARENT_MENUS = [
  ...
  { name_ko: '매출 관리', name_en: 'Sales Management', route: '/sales', icon: 'trending_up', order: 5 },
...
const SUB_MENUS: Record<string, Array<{ name_ko: string; name_en: string; route: string; icon: string; order: number }>> = {
  ...
  '/work': [
    ...
    { name_ko: '업무 보고서', name_en: 'Reports', route: '/work/reports', icon: 'assessment', order: 3 },
    { name_ko: '업무 통계', name_en: 'Statistics', route: '/work/statistics', icon: 'bar_chart', order: 4 },
  ],
  '/sales': [
    ...
    { name_ko: '전자세금계산서', name_en: 'E-Invoice', route: '/accounting/e-invoice', icon: 'receipt_long', order: 4 },
    { name_ko: '일반세금계산서', name_en: 'Invoice', route: '/accounting/invoice', icon: 'receipt', order: 5 },
    { name_ko: '전자운송장', name_en: 'E-Way Bill', route: '/accounting/eway-bill', icon: 'local_shipping', order: 6 },
  ],
  '/inventory': [
  ...
  '/accounting': [
    ...
    { name_ko: '회계장부', name_en: 'General Ledger', route: '/accounting/books', icon: 'menu_book', order: 7 },
    { name_ko: '예산 관리', name_en: 'Budget', route: '/accounting/budget', icon: 'account_balance', order: 8 },
    { name_ko: '자산 관리', name_en: 'Assets', route: '/accounting/assets', icon: 'account_balance', order: 9 },
    { name_ko: '손익계산서', name_en: 'Profit & Loss', route: '/accounting/profit-and-loss', icon: 'trending_up', order: 10 },
    { name_ko: '회계 통계', name_en: 'Statistics', route: '/accounting/statistics', icon: 'assessment', order: 11 },
  ],
  '/communication': [
