...
if ($Help) {
    ...
    Write-ColorOutput "  .\server\stop-server.ps1 -BackendOnly  # 백엔드만 중지"
    Write-ColorOutput "  .\server\stop-server.ps1 -FrontendOnly # 프론트엔드만 중지"
    Write-ColorOutput "  .\server\stop-server.ps1 -All         # 모든 Node.js 프로세스 중지"
