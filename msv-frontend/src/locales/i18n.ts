...
const ko = {
  translation: {
    ...
    vacationManagement: {
      ...
      earnedLeaveDesc3: '사용 가능한 연차 일수는 회계연도(4월~3월) 기준으로 자동 계산되며, 미사용 일수는 이월되지 않습니다.',
      fiscalYearResetNote: '모든 휴가 일수는 회계연도(4월 1일~3월 31일)가 지나면 초기화됩니다. 이전 연도 미사용 일수는 누적·이월되지 않습니다.',
      annualLeaveFiscalYear: '회계연도 {{label}} ({{start}} ~ {{end}})',
      remainingAnnualLeave: '남은 연차: {{days}}일',
      usedDays: '사용: {{days}}일',
      totalEarnedDays: '총 획득: {{days}}일',
      sickLeaveDesc1: '인도 노동법에 따라 근로자는 회계연도당 최소 12일의 유급 병가를 받을 수 있습니다.',
      sickLeaveDesc2: '질병으로 인한 휴가 신청 시 사용',
      sickLeaveDesc3: '의사 진단서 제출이 필요할 수 있습니다.',
      casualLeaveDesc1: '인도 노동법에 따라 근로자는 회계연도당 최소 12일의 개인사유 휴가를 받을 수 있습니다.',
    ...
    approval: {
      ...
      escalate: '승인 요청',
      escalateTo: '승인 요청 대상',
      escalationReason: '요청 사유',
      escalationCount: '승인 전달 {{current}}/{{max}}',
      forwardHint: '받은 결재를 다른 사람에게 승인을 요청할 수 있습니다.',
      flowColumn: '결재 흐름',
...
const en = {
  translation: {
    ...
    vacationManagement: {
      ...
      earnedLeaveDesc3: 'Available annual leave is calculated per fiscal year (Apr–Mar). Unused days do not carry over.',
      fiscalYearResetNote: 'All leave balances reset at the end of each fiscal year (1 Apr – 31 Mar). Unused days cannot be accumulated or carried forward.',
      annualLeaveFiscalYear: 'Fiscal year {{label}} ({{start}} – {{end}})',
      remainingAnnualLeave: 'Remaining annual leave: {{days}} day(s)',
      usedDays: 'Used: {{days}} day(s)',
      totalEarnedDays: 'Earned: {{days}} day(s)',
      sickLeaveDesc1: 'According to Indian labour law, employees are entitled to a minimum of 12 days of paid sick leave per fiscal year.',
      sickLeaveDesc2: 'Used for leave applications due to illness.',
      sickLeaveDesc3: 'A doctor\'s certificate may be required.',
      casualLeaveDesc1: 'According to Indian labour law, employees are entitled to a minimum of 12 days of personal leave per fiscal year.',
