  ...
  translation: {
    ...
    login: {
      ...
      signup: {
        ...
        planFreeTrial: '무료 7일 체험',
        planMonthly: 'Rs.5,000 /월',
        planYearly: 'Rs.50,000 /년',
        oncePerCompany: '회사당 1회',
        regularPrice: '정가',
        discountOff: '{{rate}}% 할인',
        labelStartDate: '사용 시작일',
        infoUsageLine: '사용 기간: {{start}} ~ {{end}}',
        infoFreeTrialPolicy:
          '무료 7일 체험은 동일 회사(회사명·사업자번호·GST)당 1회만 가능합니다. 이미 무료로 가입한 회사는 다시 무료로 등록할 수 없습니다.',
        infoAdminGrant: '가입 시 기본 admin 권한과 결제 처리 권한이 자동으로 부여됩니다.',
        paymentHint: '결제 완료 후 세금계산서를 다운로드한 뒤, 가입 완료 버튼을 눌러 종료합니다.',
        paymentInfoTitle: '결제 정보',
        lineCompany: '회사명: {{name}}',
        linePlan: '요금제: {{plan}}',
        lineUsage: '사용 기간: {{start}} ~ {{end}}',
        lineAmount: '결제 금액: Rs.{{amount}}',
        freeTrialSameFlow: '무료 체험도 동일한 절차로 확인한 뒤 가입이 완료됩니다.',
        doneSuccess: '결제 처리 및 가입 데이터 생성이 완료되었습니다.',
        taxInvoiceTitle: '세금계산서',
        lineInvoiceNo: '인보이스 번호: {{no}}',
        downloadTaxInvoice: 'Tax Invoice 다운로드',
        downloadFirstHint: '가입 완료 버튼을 쓰려면 먼저 세금계산서를 다운로드해 주세요.',
        next: '다음',
        payNow: '즉시 결제',
        previous: '이전',
        processing: '처리 중...',
        confirmFreeSignup: '무료 가입 확인',
        paymentComplete: '결제 완료',
        finishSignup: '가입 완료',
        passwordMismatch: '비밀번호 확인이 일치하지 않습니다.',
        registerFailed: '가입에 실패했습니다.',
        paymentOrderFailed: '결제 주문 생성에 실패했습니다.',
        razorpayScriptError: 'Razorpay 스크립트를 불러오지 못했습니다. 네트워크 상태를 확인해 주세요.',
        razorpayInitError: 'Razorpay 결제창을 초기화하지 못했습니다.',
        paymentCanceled: '결제가 취소되었습니다.',
        paymentFailedGeneric: '결제에 실패했습니다.',
        paymentRegisterGeneric: '결제/가입 처리 중 오류가 발생했습니다.',
        razorpayDescription: '{{plan}} 가입 결제',
        paymentSuccessAlert: '결제 완료: {{start}} ~ {{end}}'
      }
    },
    vacationManagement: {
      title: '휴가 관리',
  ...
  translation: {
    ...
    login: {
      ...
      signup: {
        ...
        planFreeTrial: '7-day free trial',
        planMonthly: 'Rs.5,000 /month',
        planYearly: 'Rs.50,000 /year',
        oncePerCompany: 'Once per company',
        regularPrice: 'Regular price',
        discountOff: '{{rate}}% off',
        labelStartDate: 'Start date',
        infoUsageLine: 'Usage period: {{start}} ~ {{end}}',
        infoFreeTrialPolicy:
          'The 7-day free trial is limited to once per company (same company name, business number, and GST). Companies that already used a free trial cannot register for free again.',
        infoAdminGrant: 'On sign-up, default admin and payment-processing permissions are granted automatically.',
        paymentHint: 'After payment, download the tax invoice, then tap Complete registration to finish.',
        paymentInfoTitle: 'Payment details',
        lineCompany: 'Company: {{name}}',
        linePlan: 'Plan: {{plan}}',
        lineUsage: 'Usage period: {{start}} ~ {{end}}',
        lineAmount: 'Amount: Rs.{{amount}}',
        freeTrialSameFlow: 'Free trial uses the same confirmation steps before registration completes.',
        doneSuccess: 'Payment and registration data have been created successfully.',
        taxInvoiceTitle: 'Tax invoice',
        lineInvoiceNo: 'Invoice no.: {{no}}',
        downloadTaxInvoice: 'Download tax invoice',
        downloadFirstHint: 'Download the tax invoice first to enable the Complete registration button.',
        next: 'Next',
        payNow: 'Pay now',
        previous: 'Back',
        processing: 'Processing…',
        confirmFreeSignup: 'Confirm free sign-up',
        paymentComplete: 'Payment complete',
        finishSignup: 'Complete registration',
        passwordMismatch: 'Password and confirmation do not match.',
        registerFailed: 'Registration failed.',
        paymentOrderFailed: 'Could not create payment order.',
        razorpayScriptError: 'Could not load Razorpay. Check your network connection.',
        razorpayInitError: 'Could not open the Razorpay checkout.',
        paymentCanceled: 'Payment was canceled.',
        paymentFailedGeneric: 'Payment failed.',
        paymentRegisterGeneric: 'An error occurred during payment or registration.',
        razorpayDescription: '{{plan}} — sign-up payment',
        paymentSuccessAlert: 'Payment complete: {{start}} ~ {{end}}'
      }
    },
    quotationManagement: {
