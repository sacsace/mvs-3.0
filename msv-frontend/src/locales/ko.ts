export default {
  translation: {
    ...
    vacationManagement: {
      ...
      leaveBalancesHint: '인도 회계연도(4/1~다음 해 3/31) 전체 기간의 예상 연차(총)에서 사용분(승인된 휴가 + 출퇴근 결근)을 뺀 잔여입니다. 「1년 이상 근속 시 연차 고정 부여」가 켜져 있으면 해당 직원은 고정 일수가 총 연차가 됩니다. 승인 대기·반려 건은 잔여에서 차감되지 않습니다. 「휴가 형태」에서 선택한 유형만 표시되며, 미사용 일수는 이월되지 않습니다. 입사일이 없으면 계산되지 않습니다.',
