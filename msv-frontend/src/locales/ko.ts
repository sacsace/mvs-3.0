export default {
  translation: {
    ...
    vacationManagement: {
      ...
      leaveBalancesHint: '인도 회계연도(4/1~다음 해 3/31) 기준, 해당 연도에 근무 예정인 개월 수(1개월=1일)가 총 연차입니다. 입사월은 제외하고 다음 달부터 카운트하며, 31일 입사는 한 달 더 제외합니다. 사용분(승인된 휴가 + 출퇴근 결근)을 뺀 값이 잔여입니다. 「1년 이상 근속 시 연차 고정 부여」가 켜져 있으면 해당 직원은 고정 일수가 총 연차가 됩니다. 승인 대기·반려 건은 잔여에서 차감되지 않습니다.',
      ...
      earnedLeaveDesc2: '회계연도 내 근무 예정 개월 수당 1일 (입사월 제외, 31일 입사 시 한 달 추가 제외)',
      earnedLeaveDesc2Forced: '근속 {{years}}년 이상 직원은 회계연도 연차 {{days}}일 고정 부여 (적립식 미적용)',
      earnedLeaveDesc3: '사용 가능한 연차 일수는 인도 회계연도(4/1~3/31) 내에서 자동 계산되며, 미사용 일수는 이월되지 않습니다.',
      forceFixedAnnualForTenure: '1년 이상 근속 시 연차 고정 부여(강제)',
      forceFixedAnnualHint: '켜면 근속 1년 이상 직원은 20일 근무당 1일 적립 대신, 아래 일수를 해당 회계연도 총 연차로 적용합니다. 1년 미만은 기존 적립식을 유지합니다.',
