export default {
  translation: {
    ...
    vacationManagement: {
      ...
      earnedLeaveDesc2Forced: '회계연도 연차 {{days}}일 고정 부여 (월별 적립 미적용, 근속 연수 무관)',
      earnedLeaveDesc3: '사용 가능한 연차 일수는 인도 회계연도(4/1~3/31) 내에서 자동 계산되며, 미사용 일수는 이월되지 않습니다.',
      forceFixedAnnualForTenure: '연차 고정 부여(강제)',
      forceFixedAnnualHint: '켜면 모든 직원의 해당 회계연도 총 연차를 아래 일수(기본 12일)로 고정합니다. 월별 적립 대신 적용됩니다.',
