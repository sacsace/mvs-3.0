export default {
  translation: {
    ...
    vacationManagement: {
      ...
      earnedLeaveDesc3: '사용 가능한 연차 일수는 입사일 기준 휴가 연도 내에서 자동 계산되며, 미사용 일수는 이월되지 않습니다.',
      fiscalYearResetNote: '모든 휴가 일수는 입사일 기준 1년 주기가 지나면 초기화됩니다. 이전 주기 미사용 일수는 누적·이월되지 않습니다.',
      leaveTypeDaysLabel: '휴가 연간 일수',
      leaveTypeDaysHint: '입사일 기준 1년 동안 사용 가능 (0 = 제한 없음)',
      annualLeaveYear: '휴가 연도 {{label}}',
      annualLeaveFiscalYear: '휴가 연도 {{label}}',
      remainingAnnualLeave: '남은 연차: {{days}}일',
      usedDays: '사용: {{days}}일',
      totalEarnedDays: '총 획득: {{days}}일',
      sickLeaveDesc1: '회사에서 지정한 병가 일수가 입사일 기준 1년 동안 적용됩니다.',
      sickLeaveDesc2: '질병으로 인한 휴가 신청 시 사용',
      sickLeaveDesc3: '의사 진단서 제출이 필요할 수 있습니다.',
      casualLeaveDesc1: '회사에서 지정한 개인사유 휴가 일수가 입사일 기준 1년 동안 적용됩니다.',
