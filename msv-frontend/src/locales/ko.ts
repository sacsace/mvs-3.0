  ...
  translation: {
    ...
    common: {
      ...
      notificationInbox: {
        ...
        contractApprovalTitle: '전자근로계약 승인 요청',
        contractApprovalBody: '{{employee}} · {{title}}',
        contractSignTitle: '전자근로계약 서명 요청',
        contractSignBody: '{{title}} · 서명이 필요합니다',
        chipPayment: '결제',
        chipVacation: '휴가',
        chipQuotation: '견적',
        chipApproval: '결재',
    ...
    companyPolicies: {
      title: '회사 정책',
      subtitle: '고용·근태·휴가·급여·기밀·POSH·퇴직 정책을 확인합니다. 회사 관리자는 탭 추가·삭제와 내용 수정이 가능하며 변경 이력이 기록됩니다.',
      empty: '표시할 정책이 없습니다.',
      ...
      addTabTitle: '정책 탭 추가',
      addTabHint: '한국어·영어 제목을 입력하면 새 탭이 추가됩니다. 내용은 이후 수정에서 작성할 수 있습니다.',
      confirmDeleteTab: '「{{name}}」 탭을 삭제할까요? 목록에서만 숨겨지며, 같은 이름으로 다시 추가하면 복구할 수 있습니다.',
      tabs: {
      ...
      success: {
        saved: '회사 정책을 저장했습니다.',
        added: '정책 탭을 추가했습니다.',
        deleted: '정책 탭을 삭제했습니다.',
      },
      errors: {
        loadFailed: '회사 정책을 불러오지 못했습니다.',
        saveFailed: '회사 정책 저장에 실패했습니다.',
        historyFailed: '변경 이력을 불러오지 못했습니다.',
        addFailed: '정책 탭 추가에 실패했습니다.',
        deleteFailed: '정책 탭 삭제에 실패했습니다.',
        titleRequired: '제목(한국어/영어)을 입력해 주세요.',
      },
    },
    ...
    userManagement: {
      ...
      personalRecordTitle: '직원 신상 명세서',
      downloadPersonalRecordPdf: '신상 명세서 PDF',
      personalRecordGeneratedAt: '작성일',
      personalRecordPdfDone: '직원 신상 명세서 PDF를 다운로드했습니다.',
      personalRecordPdfFailed: '직원 신상 명세서 PDF 다운로드에 실패했습니다.',
      personalRecordPdfGenerating: 'PDF 생성 중…',
      createdAt: '생성일',
    ...
    employmentContractManagement: {
      ...
      wizard: {
        ...
        back: '이전',
        saveDraft: '초안 저장',
        submitApproval: '승인자 제출',
        previewHint: '승인자에게 제출하기 전에 계약 내용을 확인하세요.',
        needTemplate: '템플릿과 제목을 입력해 주세요.',
        needEmployee: '근로 대상을 선택해 주세요.',
        needApprover: '승인자(근로 대상과 다른 사람)를 선택해 주세요.',
        needBasic: '계약 시작일·종료일을 입력해 주세요.',
      },
      actions: {
        approve: '승인',
        reject: '반려',
      ...
      success: {
        submitted: '승인자에게 제출했습니다.',
        approved: '승인되었습니다. 근로자 내 계약서에 표시됩니다.',
        rejected: '계약을 반려했습니다.',
        completed: '계약을 완료 처리했습니다.',
        signed: '서명이 완료되었습니다.',
        deleted: '계약을 삭제했습니다.',
      },
      stats: {
      ...
      empty: {
        ...
        noMyContractsHint: '승인자 승인 후 서명할 계약서가 여기에 표시됩니다.',
        noContractsHint: '계약 작성 버튼으로 첫 계약을 등록해 보세요.',
        noTemplatesHint: '템플릿 생성 버튼으로 첫 템플릿을 등록해 보세요.',
        noApprovals: '승인 대기 중인 계약이 없습니다.',
        noSearchResults: '검색 결과가 없습니다.',
        noSearchResultsHint: '다른 검색어를 입력해 보세요.',
      },
      ...
      filterCompleted: '완료',
      search: '검색',
      searchPlaceholder: '제목, 이름, ID, 상태 검색',
      pdfFiles: 'PDF 파일 목록',
      ...
      aadhaarSignSuccess: 'Aadhaar eSign 서명이 완료되었습니다.',
      aadhaarSignFailed: 'Aadhaar eSign 처리 중 오류가 발생했습니다.',
      aadhaarAspSteps:
        '1) 끝 4자리·동의 → 2) Aadhaar 인증 시작 → 3) Mock OTP(개발) 또는 ASP 페이지 인증 → 4) 서명 완료. live 모드는 ASP 계약 후 env 설정이 필요합니다.',
      aadhaarLast4Hint: 'ASP 본인확인용 힌트 값입니다. 실제 인증은 OTP/생체(ASP)로 진행됩니다.',
      aadhaarStart: 'Aadhaar 인증 시작',
      aadhaarComplete: '서명 완료',
      aadhaarMockOtp: 'Mock OTP (6자리)',
      aadhaarMockOtpHint: 'Mock ASP 세션입니다. 아무 6자리 OTP를 입력하세요.',
      aadhaarLiveHint: 'ASP 인증을 마친 뒤 서명 완료를 눌러 주세요.',
      aadhaarInitiated: 'Aadhaar 세션이 시작되었습니다.',
    },
    noticePoll: {
      title: '투표',
    ...
    partnerManagement: {
      ...
      sectionContact: '연락처',
      sectionBank: '계좌 정보',
      sectionContract: '계약·상태',
      companyName: '회사명',
      businessNumber: 'CIN',
      panNumber: 'PAN 번호',
      gstNumber: 'GST 번호',
      gstNumberMinMax: '(선택, 최대 10개)',
      add: '추가',
      ...
      placeholderBusinessNumber: 'CIN (선택)',
    ...
    payrollManagement: {
      ...
      searchFieldLabel: '검색',
      gridHint: '셀을 클릭해 바로 입력합니다. Tab으로 이동, 같은 열에 붙여넣기 가능. 포커스를 잃으면 저장됩니다.',
      ...
      success: {
        ...
        saved: '저장되었습니다.',
        pasteSaved: '{{count}}개 셀을 붙여 넣었습니다.',
      ...
      errors: {
        ...
        pastePartial: '붙여넣기: {{ok}}건 성공, {{fail}}건 실패',
    ...
    projectManagement: {
      title: '프로젝트 관리',
      description: '단발성이 아닌, 일정 기간 동안 진행하는 프로젝트를 등록하고 관리합니다.',
      listTitle: '프로젝트 목록 ({{count}}건)',
      empty: '등록된 프로젝트가 없습니다.',
      noResults: '검색 결과가 없습니다.',
      days: '{{count}}일',
      daysLeft: '{{count}}일 남음',
      daysOverdue: '{{count}}일 지연',
      overdueDays: '{{count}}일 지연',
      noCreatePermission: '등록 권한이 없습니다.',
      noEditPermission: '수정 권한이 없습니다.',
      ...
      detail: {
        ...
        timelineTaskAxis: '업무',
        timelineTaskCount: '{{count}}건',
        addSchedule: '일정 추가',
        editSchedule: '일정 수정',
        addTask: 'Task 추가',
        editTask: 'Task 수정',
        noSchedules: '등록된 일정이 없습니다.',
        noTasks: '등록된 Task가 없습니다.',
        noActivities: '활동 기록이 없습니다.',
        progressNote: '업무 진행 설명',
        attachments: '첨부 파일',
        ...
        postComment: '등록',
        taskColor: '타임라인 색',
        taskColorHint: '선택하지 않으면 기존 Task와 겹치지 않는 색이 자동 지정됩니다.',
        moveUp: '위로',
        moveDown: '아래로',
        statsTotal: '전체 Task',
        statsCompleted: '완료',
        ...
        startTime: '시작 시간',
        endTime: '종료 시간',
        confirmDeleteSchedule: '이 일정을 삭제하시겠습니까?',
        confirmDeleteTask: '이 Task를 삭제하시겠습니까?'
      },
      scheduleTypes: {
        milestone: '마일스톤',
        meeting: '회의',
      ...
      activityEvents: {
        ...
        task_created: 'Task 등록',
        task_updated: 'Task 수정',
        task_status_changed: 'Task 상태 변경',
        task_deleted: 'Task 삭제',
        task_comment_added: '댓글 등록',
        task_attachment_added: '첨부 추가'
      },
      actions: {
        refresh: '새로고침',
        create: '프로젝트 등록',
      ...
      confirm: {
        deleteTitle: '프로젝트 삭제',
        deleteMessage: '이 프로젝트를 비활성화하시겠습니까?'
      },
      messages: {
        created: '프로젝트가 등록되었습니다.',
        updated: '프로젝트가 수정되었습니다.',
        deleted: '프로젝트가 비활성화되었습니다.',
        invited: '멤버를 추가했습니다.',
        scheduleSaved: '일정이 저장되었습니다.',
        scheduleDeleted: '일정이 삭제되었습니다.',
        taskSaved: 'Task가 저장되었습니다.',
        taskDeleted: 'Task가 삭제되었습니다.',
        attachmentUploaded: '파일이 첨부되었습니다.'
      },
      errors: {
        loadList: '프로젝트 목록을 불러올 수 없습니다.',
        loadListTitle: '프로젝트 목록 조회 오류',
        loadDetail: '프로젝트 상세를 불러올 수 없습니다.',
        loadDetailTitle: '프로젝트 상세 조회 오류',
        notFound: '프로젝트를 찾을 수 없거나 접근 권한이 없습니다.',
        saveTitle: '프로젝트 저장 오류',
        deleteTitle: '프로젝트 삭제 오류',
        inviteTitle: '멤버 추가 오류',
        inviteFailed: '멤버 추가에 실패했습니다.',
        nameRequired: '프로젝트명을 입력하세요.',
        startRequired: '시작일을 입력하세요.',
        managerRequired: '담당자를 선택하세요.',
        endBeforeStart: '종료일은 시작일 이후여야 합니다.',
        createFailed: '프로젝트 등록에 실패했습니다.',
        updateFailed: '프로젝트 수정에 실패했습니다.',
    ...
    expenseApproval: {
      ...
      cc: {
        label: '참조',
        hint: '열람·진행 확인만 가능 (승인 불가)',
        placeholder: '참조 인원 검색·추가',
        badge: '참조'
      },
      list: {
      ...
      status: {
        ...
        approved: '승인됨',
        rejected: '반려됨',
        revisionRejected: '수정 반려',
        paid: '지급 완료',
        awaitingTaxInvoice: '택스 인보이스 대기',
      ...
      dialog: {
        ...
        revisionRejectReasonTitle: '수정 반려 사유',
        editReasonTitle: '수정 사유',
        finalApproveReasonPlaceholder: '승인 사유 (선택)',
        rejectReasonPlaceholder: '반려 사유를 입력하세요',
        revisionRejectReasonPlaceholder: '수정이 필요한 내용을 입력하세요',
      ...
      detail: {
        ...
        attachmentPreviewUnavailable:
          '이 파일 형식은 미리보기를 지원하지 않습니다. 다운로드하거나 새 탭에서 열어 주세요.',
        awaitingTaxInvoiceHint:
          '송금은 완료되었지만 Tax Invoice가 없어 종료되지 않았습니다. Tax Invoice를 첨부해 주세요.',
        attachmentLockedOnRemittance:
          '프로포마로 승인된 건은 송금 단계에서 인보이스 첨부를 변경할 수 없습니다. (송금 확인증은 송금하기에서 첨부)',
        uploadTaxInvoiceOnly: '종료하려면 Tax Invoice만 추가 첨부할 수 있습니다.',
        ...
        revisionRejectComment: '수정 반려 사유',
        amountInclTax: '세금 포함',
        paidAmount: '지급 완료',
        remainingAmount: '잔금',
        comments: '댓글',
      ...
      voucher: {
        ...
        sectionCalculationAttachments: '계산식 첨부',
        ...
        remarksRequiredGst: '비고 (계산식 없음 · 필수)',
        remarksRequiredGstHint: '계산식이 없으면 비고에 사유를 입력해야 합니다.',
        remarksInternal: '비고',
        ...
        calculationNone: '첨부된 계산식이 없습니다.',
        submitSaving: '제출 중...',
        submit: '제출',
        resubmitAfterRevisionSaving: '재제출 중...',
        resubmitAfterRevision: '수정 후 재제출',
        create: '작성',
        ...
        partnerScopeEmpty:
          '배정된 협력업체가 없습니다. 업무 담당 리스트에서 고객사를 배정한 뒤 다시 시도해 주세요.',
        partnerScopeNoMatch: '배정된 협력업체 중 검색 결과가 없습니다.',
        formTypeLabel: '전표 유형',
        formTypeGeneral: '일반',
        formTypeGst: 'GST',
        formTypeTds: 'TDS',
        ...
        gstTableSgst: 'SGST (3)',
        gstTableRowTotal: '합계',
        gstTableColumnTotal: '합계',
        gstRowSale: '(A) {{period}} 매출 합계 및 IGST',
        gstRowInputCredit: '(B) {{period}} 매입 Input Credit',
        ...
        tdsDeducteeSearchHint: '파트너명·PAN 검색',
        tdsSumAmount: 'Amount 합계',
        tdsSumTds: 'TDS 합계',
        tdsNetPayable: '최종 합계 (Amount − TDS)',
      ...
      success: {
        ...
        calculationAttached: '계산식이 첨부되었습니다.',
        ...
        resubmittedAfterRevision: '수정 후 지출결의서를 다시 제출했습니다.',
      ...
      errors: {
        ...
        requiredTitlePurpose: '제목은 필수입니다.',
        ...
        revisionRejectFailed: '수정 반려 중 오류가 발생했습니다.',
        ...
        revisionRejectReasonRequired: '수정 반려 사유를 입력해주세요.',
        editReasonRequired: '수정 사유를 입력해주세요.',
    ...
    vacationManagement: {
      ...
      loadListFailed: '휴가 목록을 불러올 수 없습니다.',
      loadListError: '휴가 목록을 불러오는 중 오류가 발생했습니다.',
      policySaved: '휴가 정책이 저장되었습니다.',
      policySaveFailed: '휴가 정책 저장에 실패했습니다.',
      policySaveError: '휴가 정책 저장 중 오류가 발생했습니다.',
      leaveApproveFailed: '휴가 승인에 실패했습니다.',
      leaveApproveError: '휴가 승인 중 오류가 발생했습니다.',
      leaveRejectFailed: '휴가 거부에 실패했습니다.',
      leaveRejectError: '휴가 거부 중 오류가 발생했습니다.',
      leaveDeleteFailed: '휴가 삭제에 실패했습니다.',
      leaveDeleteError: '휴가 삭제 중 오류가 발생했습니다.',
      unknownUser: '알 수 없음',
