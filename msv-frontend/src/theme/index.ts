...
const theme = createTheme({
  ...
  typography: {
    ...
    h1: {
      fontSize: '2rem', // 32px - 축소
      fontWeight: 700,
      lineHeight: 1.2,
      letterSpacing: '-0.025em',
    },
    h2: {
      fontSize: '1.75rem', // 28px - 축소
      fontWeight: 700,
      lineHeight: 1.3,
      letterSpacing: '-0.025em',
    },
    h3: {
      fontSize: '1.375rem', // 22px - 축소
      fontWeight: 600,
      lineHeight: 1.4,
      letterSpacing: '-0.025em',
    },
    h4: {
      fontSize: '1.125rem', // 18px - 축소
      fontWeight: 600,
      lineHeight: 1.4,
      letterSpacing: '-0.025em',
    },
    h5: {
      fontSize: '1rem', // 16px - 축소
      fontWeight: 600,
      lineHeight: 1.5,
      letterSpacing: '-0.025em',
    },
