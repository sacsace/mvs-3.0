...
CREATE INDEX IF NOT EXISTS idx_payroll_records_payroll_period ON payroll_records(payroll_period);
...
CREATE INDEX IF NOT EXISTS idx_payroll_records_tenant_period ON payroll_records(tenant_id, payroll_period);
CREATE INDEX IF NOT EXISTS idx_payroll_records_employee_period ON payroll_records(employee_id, payroll_period);
...
CREATE INDEX IF NOT EXISTS idx_payroll_records_salary ON payroll_records(net_salary);
...
ALTER TABLE payroll_records ADD CONSTRAINT chk_payroll_amounts CHECK (net_salary >= 0 AND gross_salary >= 0);
