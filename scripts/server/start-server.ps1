...
if ($Help) {
    ...
    Write-ColorOutput "  .\scripts\server\start-server.ps1               # start backend + frontend"
    Write-ColorOutput "  .\scripts\server\start-server.ps1 -BackendOnly  # start backend only"
    Write-ColorOutput "  .\scripts\server\start-server.ps1 -FrontendOnly # start frontend only"
    Write-ColorOutput "  .\scripts\server\start-server.ps1 -SkipChecks   # skip checks"
...
try {
    ...
    Write-ColorOutput "  - Or run .\scripts\server\stop-server.ps1" "White"
